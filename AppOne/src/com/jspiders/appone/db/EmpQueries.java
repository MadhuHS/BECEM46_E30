...
public class EmpQueries {
	...
	static String selectQuery = "select Emp_ID,Emp_First_Name,Emp_Last_Name,Emp_Grade,Emp_Designation where Emp_ID = ?;";
	static String selectDeptNameQuery = "select Dept_Name from Department where Dept_ID = 1;";		
	/*
